  ...
  return (
    <div className={h.header}>
      ...
      <div>
        ...
        >
          <div className={h.dropdownField} ref={dropoutUnderInput} >
            <div
              style={{
                display: "flex",
                justifyContent: "center",
            ...
            >
              <span style={{ fontSize: "15px" }} className={h.spanInField}>
                Немає нещозавних запитів
              </span>
            </div>
            <div style={{ padding: "12px 0 4px" }}>
              <span
                style={{ paddingLeft: "8px", fontSize: "17px" }}
                className={h.spanInField}
              >
                Що ще є на catbook
              </span>
            </div>
